...
function RightyMascot({ size = "md" }: { size?: "sm" | "md" }) {
  ...
  return (
    <span
      className={`righty-blink-wrap righty-mascot-jump relative grid shrink-0 place-items-center overflow-visible rounded-full bg-[#16323a]/60 p-1 ${
    ...
    >
      ...
      <img
        ...
        alt="Mascot Righty"
        className="relative z-10 h-full w-full rounded-full border border-white/30 object-contain object-center shadow-lg"
      />
