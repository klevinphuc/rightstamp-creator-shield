...
export default function FloatingRightyMascot() {
  ...
  return (
    /* Vị trí tổng thể cố định góc dưới bên trái (bottom-[-66px] left-0.5) */
    <div className="fixed bottom-[-66px] left-0.5 z-50 flex flex-col items-center select-none pointer-events-auto">
      
      {/* Bong bóng lời thoại xuất hiện trên đầu chú Mascot */}
      {/* Đmax-w-[170px] gọn gàng */}
      {/* ĐVÀ ĐÃ SỬA: Thêm translate-y-[40px] để hạ thấp ô thoại xuống sát chú mascot thêm 1,2 cm */}
      <div className="mb-1 max-w-[170px] bg-[#0a1e36]/95 text-white text-xs font-medium p-3 rounded-2xl border border-slate-700/50 shadow-xl relative animate-in fade-in slide-in-from-bottom-2 duration-300 backdrop-blur-sm text-center transform translate-y-[40px] z-20">
        {currentStep.message}
      ...
      <button
        ...
        /* Kích thước lớn 1.5x (168px) và hiệu ứng lơ lửng nhịp nhàng */
